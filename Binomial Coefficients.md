---
Question Link: https://cses.fi/problemset/task/1079/
Problem Set:
  - CSES
Last edited time: 2023-11-07T22:30
Status: Solved
tags:
  - Math
  - Mod
Key Takeaway: Modular Multiplicative Inverses of an list of number n → m, could be found in liner time.(n!)−1≡(n!)−1×(n+1)−1×(n+1)≡((n+1)!)−1×(n+1)(n!)−1≡(n!)−1×(n+1)−1×(n+1)≡((n+1)!)−1×(n+1)
---
### Solution (AC)
