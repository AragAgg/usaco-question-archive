---
Question Link: https://cses.fi/problemset/task/1202/
Problem Set:
  - CSES
Last edited time: 2024-03-17T23:18
Status: Nice Question
tags:
  - Dijkstra's-Algo
  - Implementation
  - Memoization
Key Takeaway: Nice Editorial on USACO GUIDE. unordered_map for memo might work for small constraints.
---
### Idea

1. Calculate the distance to all nodes from A, using Dijkstra’s Algorithm,
2. using a recursive DFS, and a cost constraint (to avoid loops), find the rest of the metrics required
