---
Question Link: https://open.kattis.com/problems/catandmice
Problem Set:
  - Kattis
Last edited time: 2023-12-15T17:12
Status: Nice Question
tags:
  - Binary-Search
  - Dynamic-Programming
  - Implementation
Key Takeaway: When binary searching a floating value, try not to do it using the error < epsilon method, instead loop over a constant number of times (30 - 40)Also check TL for every question on Kattis
---
### Solution (AC)
