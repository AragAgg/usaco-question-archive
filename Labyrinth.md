...
Problem Set:
  - CSES
Last edited time: 2023-12-24T13:35
Status: Solved
tags:
  - BFS
Key Takeaway: Should have used a simple string stepDir = "URDL"; instead of a shitty if-else ladder for steps reconstruction.
---
### Solution (AC)
