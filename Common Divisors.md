---
Question Link: https://cses.fi/problemset/task/1081
Problem Set:
  - CSES
Last edited time: 2023-10-28T12:37
Status: Nice Question
tags:
  - Implementation
  - Math
Key Takeaway: Do not over optimise. Especially on CSES. Implementation here is almost every time pretty straightforward.When you consider a binary search approach, and it turns out to be non-monotonic, maybe check to see if you you actually make the code faster and then simply simulate over the search space, as you already have a checker function.
---
### Solution (AC) [shitty implementation]
...
### Editorial [SOL3 is a nice idea]

> [!info] Solution - Common Divisor (CSES)  
...
> [https://usaco.guide/problems/cses-1081-common-divisors/solution](https://usaco.guide/problems/cses-1081-common-divisors/solution)