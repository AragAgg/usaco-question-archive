---
Question Link: https://usaco.org/index.php?page=viewproblem2&cpid=921
Problem Set:
  - Gold
Last edited time: 2024-04-07T22:19
...
tags:
  ...
  - LCA
---
range updates using start += delta, end+1 -= delta;

and range xor(S) using BIT on euler tour in combination wiht first and last array should do the trick. be careful with implementation choices
