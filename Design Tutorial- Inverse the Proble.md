---
Question Link: https://codeforces.com/contest/472/problem/D
Problem Set:
  - Code Forces
  - DIV2D
Last edited time: 2024-03-20T00:41
Status: Nice Question
tags:
  - Implementation
  - Kruskal's-MST
  - Optimisation
What's up: Thought of a solution, determined it might get messy (and probably not the expected ans) but it was.
Key Takeaway: Be greedy when optimizing, spend time first optimising the worst parts of your code. Look for symmetries and possible corner cutting techniques.
---
### Solution (AC)
